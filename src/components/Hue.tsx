...
const Hue = (props: Props) => {
  ...
  return (
    <div
      className="flex flex-col h-64 max-h-full aspect-square rounded-3xl text-center justify-between items-center" onDoubleClick={() => props.toggleLike && props.toggleLike(props.hue.id)}
